...
enum enum_wsrep_mode {
    WSREP_MODE_IGNORE_NATIVE_REPLICATION_FILTER_RULES = (1ULL << 0),
    WSREP_MODE_IGNORE_CASCADING_FK_DELETE_MISSING_ROW_ERROR =  (1ULL << 1),
    WSREP_MODE_APPLIER_IGNORE_MISSING_TABLE = (1ULL << 2),
};
